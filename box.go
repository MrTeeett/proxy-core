...
import (
	...
	"proxy-core/common/certificate"
	"proxy-core/common/dialer"
	"proxy-core/common/taskmonitor"
	"proxy-core/common/tls"
	C "proxy-core/constant"
	"proxy-core/dns"
	"proxy-core/dns/transport/local"
	"proxy-core/experimental"
	"proxy-core/experimental/cachefile"
	"proxy-core/experimental/libbox/platform"
	"proxy-core/log"
	"proxy-core/option"
...
func (s *Box) PreStart() error {
	...
	s.logger.Info("proxy-core pre-started (", F.Seconds(time.Since(s.createdAt).Seconds()), "s)")
	return nil
}
...
func (s *Box) Start() error {
	...
	s.logger.Info("proxy-core started (", F.Seconds(time.Since(s.createdAt).Seconds()), "s)")
	return nil
}
