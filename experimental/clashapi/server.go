...
import (
	...
	"proxy-core/adapter"
	"proxy-core/common/urltest"
	C "proxy-core/constant"
	"proxy-core/experimental"
	"proxy-core/experimental/clashapi/trafficontrol"
	"proxy-core/log"
	"proxy-core/option"
...
func NewServer(ctx context.Context, logFactory log.ObservableFactory, options option.ClashAPIOptions) (adapter.ClashServer, error) {
	...
	if options.StoreMode || options.StoreSelected || options.StoreFakeIP || options.CacheFile != "" || options.CacheID != "" {
		return nil, E.New("cache_file and related fields in Clash API is deprecated in proxy-core 1.8.0, use experimental.cache_file instead.")
	}
...
func version(w http.ResponseWriter, r *http.Request) {
	render.JSON(w, r, render.M{"version": "proxy-core " + C.Version, "premium": true, "meta": true})
}
