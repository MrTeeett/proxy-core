...
import (
	...
	"proxy-core/common/badversion"
	C "proxy-core/constant"
	"proxy-core/experimental/locale"
...
func (n Note) MessageWithLink() string {
	if n.MigrationLink != "" {
		return F.ToString(
			n.Description, " is deprecated in proxy-core ", n.DeprecatedVersion,
			" and will be removed in proxy-core ", n.ScheduledVersion, ", checkout documentation for migration: ", n.MigrationLink,
		)
	} else {
		return F.ToString(
			n.Description, " is deprecated in proxy-core ", n.DeprecatedVersion,
			" and will be removed in proxy-core ", n.ScheduledVersion, ".",
		)
	}
}
