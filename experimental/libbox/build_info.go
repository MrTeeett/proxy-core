...
const (
	...
	androidVPNCoreTypeSingBox     = "proxy-core"
...
func determinePkgType(pkgName string) (string, bool) {
	...
	if strings.Contains(pkgNameLower, "proxy-core") {
...
func determineCorePath(pkgInfo *buildinfo.BuildInfo, pkgType string) (string, bool) {
	...
	case androidVPNCoreTypeSingBox:
		return determineCorePathForPkgs(pkgInfo, []string{"proxy-core"}, []string{"proxy-core"})
