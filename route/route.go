...
func (r *Router) routeConnection(ctx context.Context, conn net.Conn, metadata adapter.InboundContext, onClose N.CloseHandlerFunc) error {
	...
	case mux.Destination.Fqdn:
		return E.New("global multiplex is deprecated since proxy-core v1.7.0, enable multiplex in Inbound fields instead.")
	case vmess.MuxDestination.Fqdn:
		return E.New("global multiplex (v2ray legacy) not supported since proxy-core v1.7.0.")
	case uot.MagicAddress:
		return E.New("global UoT not supported since proxy-core v1.7.0.")
	case uot.LegacyMagicAddress:
		return E.New("global UoT (legacy) not supported since proxy-core v1.7.0.")
	}
